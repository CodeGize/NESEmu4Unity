...
namespace dotNES
{
    partial class PPU
    {
        private readonly byte[] _oam = new byte[0x100];//256Byte
        private readonly byte[] _vram = new byte[0x2000];//8192Byte
        private readonly byte[] _paletteRAM = new byte[0x20];//32byte
